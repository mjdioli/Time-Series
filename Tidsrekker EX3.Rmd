...
```{r}
#Load data
daily_c13iso = data.frame(read.csv("/home/marius/Desktop/mlo_station_data_set/daily_flask_c13_mlo.csv"))
monthly_c13iso = read.csv("/home/marius/Desktop/mlo_station_data_set/monthly_flask_c13_mlo.csv")
daily_o18iso = read.csv("/home/marius/Desktop/mlo_station_data_set/daily_flask_o18_mlo.csv")
intermittent_c13iso = read.csv("/home/marius/Desktop/mlo_station_data_set/intermittent_flask_c14_mlo.csv")
monthly_o18iso = read.csv("/home/marius/Desktop/mlo_station_data_set/monthly_flask_o18_mlo.csv")
daily_flask = read.csv("/home/marius/Desktop/mlo_station_data_set/daily_flask_co2_mlo.csv")
monthly_flask = read.csv("/home/marius/Desktop/mlo_station_data_set/monthly_flask_co2_mlo.csv", na.strings=-99.99)
ten_min_insitu = read.csv("/home/marius/Desktop/mlo_station_data_set/ten_minute_in_situ_co2_mlo.txt")
daily_insitu = read.csv("/home/marius/Desktop/mlo_station_data_set/daily_in_situ_co2_mlo.csv", comment.char = '%')
weekly_insitu = read.csv("/home/marius/Desktop/mlo_station_data_set/weekly_in_situ_co2_mlo.csv")
monthly_insitu = read.csv("/home/marius/Desktop/mlo_station_data_set/monthly_in_situ_co2_mlo.csv")
