...
#C13
plotter(as.ts(monthly_c13iso$C13_filled, 12), 12)
plotter(as.ts(daily_c13iso$C13, 365), 365)

#O18
plotter(as.ts(monthly_o18iso$O18, 12), 12)
plotter(as.ts(daily_o18iso$O18, 365), 365)

#Weekly
plotter(as.ts(weekly_insitu$CO2, 52), 52)

#Ten minutes
plotter(as.ts(ten_min_insitu$CO2, 525600), 525600)

#Intermittent
plotter(as.ts(intermittent_c13iso$C13, 8), 8)
```
